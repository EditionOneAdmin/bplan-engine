      ...
      <div className="max-w-3xl mx-auto text-center">
        <FadeIn>
          ...
          <p className="mt-6 text-lg text-slate-text/70 leading-relaxed">
            Vereinbaren Sie eine Demo und sehen Sie B-Plan Engine mit Ihren eigenen Projekten.
        ...
        <FadeIn delay={0.2}>
          <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
            <motion.a
              href="mailto:hello@bplanengine.de"
        ...
        <FadeIn delay={0.3}>
          <p className="mt-8 text-sm text-slate-text/40">
            Oder direkt per E-Mail: hello@bplanengine.de
          </p>
        </FadeIn>
      </div>
    </section>
