  ...
  return (
    <motion.header className="fixed top-0 right-0 left-0 z-50 border-b border-gray-border/60 bg-white/80 backdrop-blur-lg" initial={{ y: -80 }} animate={{ y: 0 }} transition={{ duration: 0.5 }}>
      <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-3">
        ...
        <a href="/bplan-engine/#kontakt" className="rounded-lg bg-accent px-5 py-2 text-sm font-semibold text-white transition hover:bg-accent-light">
          Demo anfragen
        </a>
      </div>
    </motion.header>
  ...
  return (
    <section className="relative overflow-hidden bg-primary pt-28 pb-20 md:pt-36 md:pb-28">
      <div className="absolute inset-0 opacity-20">
        <img src="/bplan-engine/images/usecase-seriell.jpg" alt="" className="h-full w-full object-cover" />
      </div>
      ...
      <div className="relative mx-auto max-w-6xl px-6">
        <FadeIn>
          ...
          <a href="/bplan-engine/#kontakt" className="inline-flex items-center gap-2 rounded-lg bg-accent px-6 py-3 text-sm font-semibold text-white transition hover:bg-accent-light">
    ...
    <Section>
      <FadeIn>
        ...
        <p className="mb-12 max-w-3xl text-lg leading-relaxed text-slate-text/70">
          Sie haben ein bewährtes MFH-Konzept: 4 Geschosse, 12 Wohneinheiten, optimierte Grundrisse. Aber für jeden neuen Standort beginnt die Planung von vorne — weil die B-Plan Constraints anders sind. Die B-Plan Engine macht Schluss damit.
        </p>
      </FadeIn>
    ...
    <Section>
      <FadeIn>
        ...
        <p className="mb-12 max-w-3xl text-lg text-slate-text/60">
          Ein Wohnungsbauunternehmen appliziert sein MFH-Standard-Template auf 10 verschiedene Grundstücke. Die B-Plan Engine prüft automatisch, wo der Standard passt — und wo er angepasst werden muss.
        </p>
      </FadeIn>
      {/* Mini table */}
      <FadeIn delay={0.1}>
    ...
    <Section>
      <FadeIn>
        <div className="rounded-3xl bg-primary px-8 py-16 text-center md:px-16">
          ...
          <a href="/bplan-engine/#kontakt" className="inline-flex items-center gap-2 rounded-lg bg-accent px-8 py-4 text-base font-semibold text-white transition hover:bg-accent-light">
