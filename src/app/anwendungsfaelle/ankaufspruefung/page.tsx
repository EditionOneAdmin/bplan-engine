  ...
  return (
    <section className="relative overflow-hidden bg-primary pt-28 pb-20 md:pt-36 md:pb-28">
      <div className="absolute inset-0 opacity-20">
        <img src="/bplan-engine/images/usecase-ankauf.jpg" alt="" className="h-full w-full object-cover" />
      </div>
      ...
      <div className="relative mx-auto max-w-6xl px-6">
        <FadeIn>
          ...
          <p className="mb-8 max-w-2xl text-lg leading-relaxed text-white/70">
            Vor dem LOI wissen, ob das Grundstück funktioniert. Die B-Plan Engine liefert eine datenbasierte Entscheidungsgrundlage — in 48 Stunden statt Wochen.
          </p>
