  ...
  return (
    <section className="relative overflow-hidden bg-primary pt-28 pb-20 md:pt-36 md:pb-28">
      <div className="absolute inset-0 opacity-20">
        <img src="/bplan-engine/images/usecase-portfolio.jpg" alt="" className="h-full w-full object-cover" />
      </div>
      ...
      <div className="relative mx-auto max-w-6xl px-6">
        <FadeIn>
          ...
          <p className="mb-8 max-w-2xl text-lg leading-relaxed text-white/70">
            Projektentwickler mit großen Portfolios können nicht jeden Standort manuell prüfen. Die B-Plan Engine batch-analysiert alle Flurstücke parallel — in einem Bruchteil der Zeit.
          </p>
      ...
      <div className="space-y-8">
        ...
        <FadeIn delay={0.2}>
          <div className="rounded-2xl border border-accent/20 bg-white p-6">
            <div className="mb-4 text-sm font-semibold text-accent">Mit B-Plan Engine</div>
            <div className="relative h-12 overflow-hidden rounded-xl bg-gray-bg">
      ...
      <FadeIn>
        <div className="rounded-3xl bg-primary px-8 py-16 text-center md:px-16">
          ...
          <p className="mx-auto mb-8 max-w-xl text-lg text-white/60">
            Erfahren Sie in einer Live-Demo, wie die B-Plan Engine Ihr gesamtes Portfolio in Wochen statt Monaten analysiert.
          </p>
