      ...
      <div className="mx-auto flex max-w-6xl flex-col items-center px-6 text-center">
        ...
        >
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg leading-relaxed text-slate-text/70 md:text-xl">
            U-Plan Engine automatisiert und optimiert die Machbarkeitsprüfung &
  ...
  return (
    <Section id="problem" gray>
      <FadeIn className="mb-8 max-w-2xl mx-auto">
        ...
        <img src="/uplan-engine/images/problem-documents.jpg" alt="Bauantrags-Dokumente mit Nachforderungen" className="w-full h-48 object-cover rounded-2xl shadow-lg" />
      </FadeIn>
